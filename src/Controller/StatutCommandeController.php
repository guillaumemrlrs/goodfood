...
class StatutCommandeController extends AbstractController
{
    ...
    #[Route('/{idStatutCommande}', name: 'statut_commande_show', methods: ['GET'])]
    ...
    #[Route('/{idStatutCommande}/edit', name: 'statut_commande_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{idStatutCommande}', name: 'statut_commande_delete', methods: ['POST'])]
    public function delete(Request $request, StatutCommande $statutCommande, EntityManagerInterface $entityManager): Response
    {
        if ($this->isCsrfTokenValid('delete'.$statutCommande->getIdStatutCommande(), $request->request->get('_token'))) {
