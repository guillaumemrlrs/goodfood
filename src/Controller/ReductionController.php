...
class ReductionController extends AbstractController
{
    ...
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('reduction_index', [], Response::HTTP_SEE_OTHER);
        }
    ...
    #[Route('/{idReduction}', name: 'reduction_show', methods: ['GET'])]
    ...
    #[Route('/{idReduction}/edit', name: 'reduction_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{idReduction}', name: 'reduction_delete', methods: ['POST'])]
    public function delete(Request $request, Reduction $reduction, EntityManagerInterface $entityManager): Response
    {
        if ($this->isCsrfTokenValid('delete'.$reduction->getIdReduction(), $request->request->get('_token'))) {
